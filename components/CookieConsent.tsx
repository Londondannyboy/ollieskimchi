        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex-grow">
            <p className="text-sm md:text-base">
              ...
              <Link href="/privacy" className="text-kimchi-red hover:underline">
                Privacy Policy
              </Link>{' '}
              and{' '}
              <Link href="/terms" className="text-kimchi-red hover:underline">
                Terms of Service
              </Link>.
            </p>
          </div>
          <div className="flex gap-3 flex-shrink-0">
            ...
            <button
              ...
              className="px-6 py-2 bg-kimchi-red text-white font-semibold rounded-full hover:bg-red-600 transition-colors text-sm"
            >
              Accept
            </button>
          </div>
