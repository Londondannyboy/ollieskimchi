            ...
            <div className="sticky top-24 space-y-6">
                    ...
                    {relatedArticles.slice(0, 4).map((related) => (
                      ...
                      >
                        {related.hero_image_url ? (
                          ...
                          <div className="w-20 h-20 flex-shrink-0 rounded-lg bg-gradient-to-br from-kimchi-red/20 to-red-100 flex items-center justify-center">
                            <svg className="w-8 h-8 text-kimchi-red/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-6 text-white">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 bg-kimchi-red rounded-xl flex items-center justify-center">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-bold">Try Ollie&apos;s Kimchi</p>
                    <p className="text-sm text-gray-400">Handcrafted in the UK</p>
                  </div>
                </div>
                <p className="text-sm text-gray-300 mb-4">
                  Fresh, naturally fermented, and packed with probiotics.
                </p>
                <Link
                  href="/shop"
                  className="block w-full py-3 bg-kimchi-red text-white text-center font-bold rounded-full hover:bg-red-600 transition-colors"
                >
                  Shop Now
                </Link>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-2xl p-6 text-white">
                ...
                <p className="text-sm text-white/80 mb-4">
                  Behind the scenes, recipes & kimchi adventures
                </p>
                <a
                  href="https://www.instagram.com/ollieskimchi/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full py-3 bg-white text-gray-900 text-center font-bold rounded-full hover:bg-gray-100 transition-colors"
                >
                  Follow Us
                </a>
              </div>
