    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-10 right-10 w-64 h-64 bg-red-900 rounded-full blur-3xl" />
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="px-2 py-1 bg-red-900/10 text-red-900 text-xs font-bold rounded-full capitalize">
                        {article.cluster}
                      </span>
                    ...
                    <h2 className="text-xl font-bold text-gray-900 group-hover:text-red-900 transition-colors mb-2 line-clamp-2">
                      {article.title}
                    </h2>
                    ...
                    <div className="flex items-center text-red-900 font-medium text-sm">
                      Read more
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center justify-center px-8 py-4 bg-red-900 text-white font-bold rounded-full text-lg hover:bg-red-700 transition-colors"
          >
            Shop Now
          </Link>
        </div>
